 ...
 */
public class TooManyPoolIssue {

    private static LogUtil logUtil = LogUtil.get(TooManyPoolIssue.class);
    ...
    public static void main(String[] args) {
        for (int requestTimes = 0; requestTimes < 2; requestTimes++) {
            ThreadPoolExecutor executor = new ThreadPoolExecutor(2, 2, 0, TimeUnit.SECONDS,
                new ArrayBlockingQueue<>(10), new NightWatcherThreadFactory("too-many-" + requestTimes + "-"));
